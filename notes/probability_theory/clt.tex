...
\begin{proof}
    ...
    \begin{equation*}
        ...
        \end{split}
    \end{equation*}
    Let $A = \E\sbrc{\abs{Y}^3}$ where $Y$ is standard normal and 
    $\sigma_n^2 = \sum_{i\leq n}\sigma_{n,i}^2$. The claim applies 
    to $Z_{n,i}$ gives 
    \begin{equation*}
        \begin{split}
            ...
            &\leq \frac{\abs{t}^3}{6}\E\sbrc{\abs{Y}^3}\sigma_n\sup_{i\leq n}\sigma_{n,i}
        \end{split}
    \end{equation*} 
    Hence 
    \begin{equation*}
